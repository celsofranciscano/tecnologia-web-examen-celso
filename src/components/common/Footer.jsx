      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-8">
          <div className=" flex items-center justify-center flex-col">
           ...
           <img className="w-60" src="https://imcruz-bolivia.s3.amazonaws.com/manual_marca/LOGO_IMCRUZ_02.jpg" alt="" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>
                <a href="/tienda" className="hover:text-blue-300">
                  Tienda
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/quienes" className="hover:text-blue-300">
                  Nosotros
                </a>
              </li>
            </ul>
